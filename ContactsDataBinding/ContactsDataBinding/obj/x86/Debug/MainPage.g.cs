#pragma checksum "C:\Users\bptnbs\source\repos\ContactsDataBinding\ContactsDataBinding\MainPage.xaml" "{8829d00f-11b8-4213-878b-770e8597ac16}" "DF160CF475421FC721105AB6EB4400ABFAABE70FBFA1598D47837B7B7C188093"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace ContactsDataBinding
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        private class MainPage_obj4_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::ContactsDataBinding.Models.Contact dataRoot;
            ...
            {
                if (lineNumber == 77 && columnNumber == 32)
                {
            ...
            public void ProcessBindings(global::System.Object item, int itemIndex, int phase, out int nextPhase)
            {
                ...
                this.Update_((global::ContactsDataBinding.Models.Contact) item, 1 << phase);
            }
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::ContactsDataBinding.Models.Contact)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            private void Update_(global::ContactsDataBinding.Models.Contact obj, int phase)
            {
                if (obj != null)
                {
        ...
        private class MainPage_obj13_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::ContactsDataBinding.Models.Icon dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            private bool removedDataContextHandler = false;
            ...
            public void ProcessBindings(global::System.Object item, int itemIndex, int phase, out int nextPhase)
            {
                ...
                this.Update_((global::ContactsDataBinding.Models.Icon) item, 1 << phase);
            }
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::ContactsDataBinding.Models.Icon)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::ContactsDataBinding.Models.Icon obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
        ...
        private class MainPage_obj1_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::ContactsDataBinding.MainPage dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::ContactsDataBinding.MainPage)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::ContactsDataBinding.MainPage obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            private void Update_Contacts(global::System.Collections.ObjectModel.ObservableCollection<global::ContactsDataBinding.Models.Contact> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
            ...
            private void Update_Icons(global::System.Collections.Generic.List<global::ContactsDataBinding.Models.Icon> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
